    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
      <div class="max-w-screen-xl mx-auto flex items-center justify-between p-4">
        ...
        <div class="grid grid-cols-3 gap-2">
          <button
            type="button"
            class="w-10 h-10 relative inline-flex items-center justify-center border border-primary-600 items-center text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:focus:ring-blue-800"
          >
            <svg
              fill="#0174DF"
              stroke-width="0"
          ...
          <button
            type="button"
            class="w-10 h-10 relative inline-flex justify-center items-center border border-primary-600 text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:focus:ring-blue-800"
          >
            <svg
              fill="#0174DF"
              stroke-width="0"
          ...
          <button
            type="button"
            class="w-10 h-10 flex justify-center items-center bg-gray-500 text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            <img
              class="h-full w-full rounded-full"
              src="https://animals.net/wp-content/uploads/2018/08/Siberian-Husky-5.jpg"
              alt=""
            />
          </button>
        </div>
